...
public class EnterInsurantDataPage extends HomePage {
    ...
    public EnterInsurantDataPage checkGenderBtn(String value) {
        ...
        switch (type) {
            case MALE:
                SeleniumHelper.jsClick(genderMaleChkBx, "Male radio Btn is selected");
                break;
            case FEMALE:
                SeleniumHelper.jsClick(genderFeMaleChkBx, "Female Btn is selected");
                break;

            default:
                throw new ValueNotFoundException("Incorrect value passed");
        }
    ...
    public EnterInsurantDataPage selectHobbies(String hobby) {
        switch (hobby) {
            case "Speeding":
                SeleniumHelper.jsClick(speedingChkBx, "Speeding radio Btn is selected");
                break;
            case "Bungee Jumping":
                SeleniumHelper.jsClick(bungeejumpingChkBx, "Bungee Jumping radio Btn is selected");
                break;
            case "Cliff Diving":
                SeleniumHelper.jsClick(cliffdivingChkBx, "Cliff Diving radio Btn is selected");
                break;
            case "Skydiving":
                SeleniumHelper.jsClick(skyDivingChkBx, "Skydiving radio Btn is selected");
                break;
            case "Other":
                SeleniumHelper.jsClick(otherChkBx, "Other radio Btn is selected");
                break;
