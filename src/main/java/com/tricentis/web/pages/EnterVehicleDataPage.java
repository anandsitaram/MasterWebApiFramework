...
public class EnterVehicleDataPage extends HomePage {
    ...
    public EnterVehicleDataPage checkRightHandDrive(String selection) {
        switch (selection.toLowerCase()) {
            case "yes":
                SeleniumHelper.jsClick(rightDriverYsChkBx, "RightHandDriver check box is selected as YES");
                break;
            case "no":
                SeleniumHelper.jsClick(rightDriverNoChkBx, "RightHandDriver check box is selected as NO");
                break;
