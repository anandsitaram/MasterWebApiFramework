...
public class EnterProductDataPage extends HomePage {
    ...
    public EnterProductDataPage selectOptionalProducts(String optionalProduct){
        ...
        switch(optionalProduct){
            case "Euro Protection":   SeleniumHelper.jsClick(euroProtectChkBx,optionalProduct+" radio button is selected");
                break;
            case "Legal Defense Insurance":   SeleniumHelper.jsClick(legalDefenseChkBx,optionalProduct+"radio button is selected");
                break;
